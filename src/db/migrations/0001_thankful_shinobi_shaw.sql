ALTER TABLE "todo" ADD COLUMN "created_at" timestamp with time zone DEFAULT now() NOT NULL;--> statement-breakpoint
ALTER TABLE "todo" ADD COLUMN "user_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "todo" ADD COLUMN "user_ids" text[] DEFAULT '{}' NOT NULL;--> statement-breakpoint
